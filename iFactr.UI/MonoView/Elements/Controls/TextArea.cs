...
namespace iFactr.UI.Controls
{
    ...
    /// </summary>
	public class TextArea : Control, ITextArea
	{
...
#endif
		private ITextArea NativeControl
        {
            get { return (ITextArea)Pair; }
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="iFactr.UI.Controls.TextArea"/> class.
        /// </summary>
		public TextArea()
		{
			Pair = MXContainer.Resolve<ITextArea>();
